...
$.fn.flip = function(settings){
    return this.each( function() {
		...
		var revertedSettings = {
			...
			bgColor: acceptHexColor(settings.color) || "#eb7518",
        ...
        flipObj = {
            ...
            toColor: acceptHexColor(settings.color) || "#eb7518",
            speed: settings.speed || 200,
            top: $this.offset().top,
        ...
        var defaultHorizontal=function() {
            ...
            return {
                ...
                "first": {
                    ...
                    borderBottomWidth: 0,
                    borderTopColor: '#c96211',
                    borderBottomColor: '#c96211',
        ...
        var defaultVertical=function() {
            ...
            return {
                ...
                "first": {
                    ...
                    borderLeftColor: '#c96211',
                    borderRightColor: '#c96211',
